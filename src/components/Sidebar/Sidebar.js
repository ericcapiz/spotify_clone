...
const Sidebar = () => {
    ...
    return (
        <div className="sidebar">
            ...
            <SidebarOption Icon={HomeIcon} id={null} title="Home"/>
            <SidebarOption Icon={SearchIcon} id={null}  title="Search"/>
            <SidebarOption Icon={LibraryMusicIcon} id={null}  title="Your Library"/>
            <br />
